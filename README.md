...
python app.py
```
Make sure that the [plots](plots) folder already contains all the necessary JSON files to render the figures (they should be downloaded within this repo).
